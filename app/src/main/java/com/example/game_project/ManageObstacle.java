...
public class ManageObstacle implements GameObstacles {
    ...
    private class ObstaclePair implements GameObstacles {
        ...
        public ObstaclePair(ObstaclePair old_op) {
            ...
            obstacles.add(new Obstacles(new Rect(
                    0,
        ...
        public ObstaclePair(int height) {
            ...
            this.obstacles = new ArrayList<>();
            // left puppy
            this.obstacles.add(new Obstacles(new Rect(
                    0,           // left
                    height,      // top
